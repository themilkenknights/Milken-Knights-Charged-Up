...
public class Arm {
    /**
     * This function assumes that the base of the arm is at the origin (0,0) 
     * and the angles are measured from the horizontal line.
     * To account for gravity, you can add a third link that is perpendicular 
     * to the base of the arm and always points downward. You can then use the 
     * same methods to calculate the angle for this third link.
     * openai
     * @param link1
     * @param link2
     * @param x
    ...
    double link1Angle = Math.acos((Math.pow(link1, 2) + Math.pow(dist, 2) - Math.pow(link2, 2)) / (2 * link1 * dist));
