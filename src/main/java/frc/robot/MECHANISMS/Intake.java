...
public class Intake {
  ...
  public void moveBottomIntakePID(double setpoint) {
    bottomLeft.set(
        ControlMode.PercentOutput, bottomIntake.calculate(getBottomPositionNative(), setpoint));
    bottomRight.set(
        ControlMode.PercentOutput, bottomIntake.calculate(getBottomPositionNative(), setpoint));
  }
  ...
  public void updateIntake() {
    ...
    bottomPID.setDouble(
        bottomIntake.calculate(getBottomPositionNative(), bottomIntake.getSetpoint()));
